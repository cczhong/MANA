...
static const uint32_t SRF_VALIDATE_DNA = 4;
static const uint32_t SRF_VALIDATE_PROT = 8;

//
class SeqReader
{
    public:
        SeqReader(std::string filename, uint32_t flags = 4);  // by default validate DNA sequence
        ~SeqReader();
